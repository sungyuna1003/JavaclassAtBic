...
public class ImageViewEx2_1 extends MFrame implements ActionListener {
	...
	public ImageViewEx2_1(String name) {
		super(600,400);
		this.name = name;
	...
	public void paint(Graphics g) {
	   ...
	   switch(idx) {
	   case SHOW_NORM: 
	   //4: Frame 좌표, 4개: 이미지 좌표
	   g.drawImage(img, 0, 0, iw, ih, 0, 0, iw, ih, this);
		   break;
	   case SHOW_PART: 
		   g.drawImage(img, 100, 100, 300, 300, 220, 20, 420, 220, this);
		   break;
	   case SHOW_SCALE: 
	   ...
	   case SHOW_VERTICAL: 
		   ...
		   break;
	   case SHOW_ALL: 
		   g.drawImage(img, 0, iw, ih, 0, 0, 0, iw, ih, this);
		   break;
	   }
	}

	public static void main(String[] args) {
		new ImageViewEx2_1("img1.jpg");
	}
}
